...
//�a marche
	...
	void filterResto(ActionEvent event) {
		...
		if (v1.equals("tous") && v2.equals("tous")) {
			System.out.println("filtre resto j'ai cliqu� sur tous ");
			List<Plat> plats = platService.findAll();
			if (plats == null) {
		...
		if (v1.equals("tous") && !v2.equals("tous") && !v2.equals("")) {
			System.out.println("filtre resto j'ai cliqu� sur tous et l'autre n'est pas tous  ");
...
//			diplay(plats);
			...
			System.out.println("filtrer ville j'ai cliqu� sur tous ");
			return;
		}
...
// �a marche
	...
	void livrer(ActionEvent event) throws IOException {
		...
		if (event.getSource().equals(btnValiderLiv)) {
			...
			if (zone == null || ville == null || adresse == null || adresse.isEmpty() || zone.isEmpty()
				...
				alert.setTitle("D�tail de votre commande");
			...
			alert.setContentText(
					" Votre commande sera liv� dans les prochaines heures \nPaiement : � la livraison \nAdresse "
							+ adresse);
			alert.showAndWait();
			pnlHome.toFront();
	...
	void commander(ActionEvent event) throws IOException {
		...
		if(paniers == null || paniers.isEmpty()) {
			...
			alert.setContentText("Veuillez ajouter des plats � votre panier pour pouvoir commander.");
			alert.showAndWait();
			return;
		}
